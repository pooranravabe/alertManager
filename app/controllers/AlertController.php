...
class AlertController extends BaseController {
  ...
  return Redirect::to('alert/allTypes');
	...
	public function addedSubAlert(){
		...
		$subscriptionId = addslashes(Input::get('subscriptionId'));
		$roleId = addslashes(Input::get('roleId'));
		...
		if($alertSubName != null){
			...
			if($checkAlert == null){
					...
					$alerttype->subscription_id = $subscriptionId;
					$alerttype->subscription_role = $roleId;					
